...
def run_crew_migration(file_content, source_type, model_type, custom_llm):
    ...
    tasks = [
        ...
        Task(description=f"Review the final, optimized DBT model SQL for correctness, formatting, and style. The output should be the final production-ready SQL.", expected_output="The final, production-ready DBT model SQL, formatted with correct indentation and comments.", agent=quality_reviewer)
    ]
