...
if current_page == "Home":
    ...
    user = st.text_input("User", value=st.session_state.get("user", ""))
    password = st.text_input("Password", type="password", value=st.session_state.get("password", ""))
    account = st.text_input("Account", value=st.session_state.get("account", ""))
    warehouse = st.text_input("Warehouse", value=st.session_state.get("warehouse", ""))
    database = st.text_input("Database", value=st.session_state.get("database", ""))
    schema = st.text_input("Schema", value=st.session_state.get("schema", ""))
