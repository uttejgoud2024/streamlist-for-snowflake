...
def run_crew_migration(file_content, source_type, model_type, custom_llm):
    ...
    # If a summary is still not found, log a warning
    if not oracle_logic_summary or oracle_logic_summary == "No summary available.":
         logging.warning("No summary was generated by the Oracle PL/SQL Analyst. The CrewAI output might have an unexpected format. Please check the logs.")
